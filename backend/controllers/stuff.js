...
exports.createSauce = (req, res, next) => {
  ...
  const sauce = new Sauce({
    //Nouvelle instance du modèle Sauce en lui passant un objet JavaScript
...
exports.modifySauce = (req, res, next) => {
  ...
  ) //nouvelle version de l'objet en deuxième en paramètre
...
exports.deleteSauce = (req, res, next) => {
  Sauce.findOne({ _id: req.params.id })
    .then((sauce) => {
      const filename = sauce.imageUrl.split("/images/")[1];
      fs.unlink(`images/${filename}`, () => {
        //fonction unlink du package fs permet de supprimer un fichier
...
exports.getOneSauce = (req, res, next) => {
  // ':' pour rendre accessible en tant que paramètre
